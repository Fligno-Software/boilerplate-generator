...
/**
 * Class ProviderEnableCommand
 *
 * @author James Carlo Luchavez <jamescarlo.luchavez@fligno.com>
 */
class ProviderEnableCommand extends ProviderMakeCommand
{
     ...
     * @var string
     */
    protected $name = 'bg:provider:enable';
     ...
     * @var string
     */
    protected $description = 'Enable a service provider in Laravel or in a specific package.';
